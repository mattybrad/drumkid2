...
class Triggers {
    public:
        ...
        void sendClockPulse(absolute_time_t startTimeUs);
        
    private:
        uint16_t _pulseLengthMs = 10; // pulse length in milliseconds
        static constexpr uint8_t _triggerPins[NUM_TRIGGER_OUTPUTS] = {Pins::TRIGGER_1, Pins::TRIGGER_2, Pins::TRIGGER_3, Pins::TRIGGER_4};
