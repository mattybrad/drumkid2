...
// MB adding Pimoroni Pico Audio pins
...
#define SINE_WAVE_TABLE_LEN 8192
...
int main()
{
    ...
    {
        sine_wave_table[i] = 0.5 * 32767 * (cosf(i * 2 * (float)(1 * M_PI / SINE_WAVE_TABLE_LEN)) + cosf(i * 2 * (float)(2 * M_PI / SINE_WAVE_TABLE_LEN)));
    }
